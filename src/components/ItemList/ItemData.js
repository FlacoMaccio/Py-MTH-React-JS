...
const listProducts = [
  {
    id: 1,
    title: "Shampoo NXT",
    description: "Shampoo sintetico Meguiars. Afloja y disuelve hasta la tierra o suciedad más difíciles, alto nivel de lubricidad. Contenido neto 1.89lts",
    price: "$3000",
    pictureUrl:
  ...
  },
  {
    id: 2,
    title: "Cera NXT",
    description: "Cera Sintentica Meguiars, otorga acabados  con mayor profundidad de color y reflejos más intensos. Contenido Neto: 311 grs",
    price: "$4500",
    pictureUrl:
  ...
  },
  {
    ...
    description: "Quick Detailer, un detallador en spray que verdaderamente repele el agua, tolera varios lavados y otorga un brillo extremo. Contenido neto 750 mL",
    price: "$3500",
    pictureUrl:
  ...
  },
  {
    id: 4,
    title: "Tire Gel",
    description: "Acondicionador de cubuiertas Meguiars, acabado mate y larga duracion",
    price: "$3000",
    pictureUrl:
